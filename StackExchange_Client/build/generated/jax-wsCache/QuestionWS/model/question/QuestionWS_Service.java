 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://question.model/", wsdlLocation = "http://localhost:8081/StackExchange_WS/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://question.model/", "QuestionWS");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://question.model/", "QuestionWSPort"), QuestionWS.class);
    }
