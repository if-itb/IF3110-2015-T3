...
public class edit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            editQ(token,id,topic,content);
            out.println("Question edited successfully!<br>");
    ...
    private void editQ(java.lang.String token, int id, java.lang.String topic, java.lang.String content) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        stackexchangews.Operation port = service.getOperationPort();
        port.editQ(token, id, topic, content);
    }
