 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://QuestionModel/", wsdlLocation = "http://localhost:8081/StackExchange_WS/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://QuestionModel/", "QuestionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StackExchange_WS/QuestionWS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://QuestionModel/", "QuestionWSPort"), QuestionWS.class);
    }
    ...
    public QuestionWS getQuestionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://QuestionModel/", "QuestionWSPort"), QuestionWS.class, features);
    }
