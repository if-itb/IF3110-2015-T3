 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://controllers/", wsdlLocation = "http://localhost:8081/StackExchange_WebService/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://controllers/", "UserWS");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://controllers/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controllers/", "UserWSPort"), UserWS.class, features);
    }
