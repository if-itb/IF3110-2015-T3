 ...
 * 
 */
@WebServiceClient(name = "Operation", targetNamespace = "http://stackexchangews/", wsdlLocation = "http://localhost:8080/Operation/Operation?wsdl")
    ...
    extends Service
{
    ...
    private final static QName OPERATION_QNAME = new QName("http://stackexchangews/", "Operation");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Operation/Operation?wsdl");
     ...
     *     returns Operation
     */
    @WebEndpoint(name = "OperationPort")
    public Operation getOperationPort() {
        return super.getPort(new QName("http://stackexchangews/", "OperationPort"), Operation.class);
    }
     ...
     */
    @WebEndpoint(name = "OperationPort")
    public Operation getOperationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://stackexchangews/", "OperationPort"), Operation.class, features);
    }
