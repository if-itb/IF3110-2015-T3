 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://WSModel/", wsdlLocation = "http://localhost:8081/StackExchange_WS/WS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://WSModel/", "WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StackExchange_WS/WS?wsdl");
    ...
    public WS getWSPort() {
        return super.getPort(new QName("http://WSModel/", "WSPort"), WS.class);
    }
    ...
    public WS getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WSModel/", "WSPort"), WS.class, features);
    }
