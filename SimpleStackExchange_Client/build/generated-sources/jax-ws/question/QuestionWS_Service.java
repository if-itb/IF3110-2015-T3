 ...
 * 
 */
@WebServiceClient(name = "Question_WS", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8081/SimpleStackExchange_Webservice/Question_WS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://webservice/", "Question_WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/SimpleStackExchange_Webservice/Question_WS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://webservice/", "Question_WSPort"), QuestionWS.class);
    }
