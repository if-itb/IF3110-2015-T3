    ...
    <body>
      ...
      <div class="container">
          ...
          <div class="form-group">
                ...
                <input name="topic" type="text" id="inputTopic" class="form-control" placeholder="Topic Question" required="" autofocus="" value="${question.getTopic()}">
          </div>
          <div class="form-group">
            <textarea placeholder="Content" id="inputContent" class="form-control" rows="5" name="content">${question.getContent()}</textarea>
          </div>
