 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://QuestionModel/", wsdlLocation = "http://localhost:8002/WS/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8002/WS/QuestionWS?wsdl");
