<%-- 
    Document   : question
    Created on : Nov 16, 2015, 11:26:16 AM
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <form action="/controller/answer.php" action="POST">
