 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://jaxws/", wsdlLocation = "http://localhost:8081/Web_Service/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://jaxws/", "QuestionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Web_Service/QuestionWS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://jaxws/", "QuestionWSPort"), QuestionWS.class);
    }
    ...
    public QuestionWS getQuestionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws/", "QuestionWSPort"), QuestionWS.class, features);
    }
