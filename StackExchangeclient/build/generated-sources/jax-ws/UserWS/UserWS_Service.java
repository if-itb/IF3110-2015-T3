 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://jaxws/", wsdlLocation = "http://localhost:8081/Web_Service/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://jaxws/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Web_Service/UserWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://jaxws/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws/", "UserWSPort"), UserWS.class, features);
    }
