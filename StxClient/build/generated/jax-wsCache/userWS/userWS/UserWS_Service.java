 ...
 * 
 */
@WebServiceClient(name = "userWS", targetNamespace = "http://userOperation/", wsdlLocation = "http://localhost:8081/StxWS/userWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://userOperation/", "userWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StxWS/userWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://userOperation/", "userWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://userOperation/", "userWSPort"), UserWS.class, features);
    }
