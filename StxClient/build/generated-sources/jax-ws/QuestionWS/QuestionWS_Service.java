 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://QuestionOperation/", wsdlLocation = "http://localhost:8081/StxWS/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://QuestionOperation/", "QuestionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StxWS/QuestionWS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://QuestionOperation/", "QuestionWSPort"), QuestionWS.class);
    }
    ...
    public QuestionWS getQuestionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://QuestionOperation/", "QuestionWSPort"), QuestionWS.class, features);
    }
