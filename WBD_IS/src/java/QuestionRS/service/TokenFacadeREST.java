 ...
 */
package QuestionRS.service;

import AnswerRS.Token;
...
public class TokenFacadeREST extends AbstractFacade<Token> {
    ...
    @PersistenceContext(unitName = "WBD_ISPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Token entity) {
        super.edit(entity);
    }
    ...
    public Token find(@PathParam("id") Integer id) {
