 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://QuestionModule/", wsdlLocation = "http://localhost:8080/Stackexchange_Webservice/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://QuestionModule/", "QuestionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Stackexchange_Webservice/QuestionWS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://QuestionModule/", "QuestionWSPort"), QuestionWS.class);
    }
    ...
    public QuestionWS getQuestionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://QuestionModule/", "QuestionWSPort"), QuestionWS.class, features);
    }
