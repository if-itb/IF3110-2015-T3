 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://UserModel/", wsdlLocation = "http://localhost:8081/StackExchangeWS/UserWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/StackExchangeWS/UserWS?wsdl");
