 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://UserModel/", wsdlLocation = "http://localhost:8082/StackExchangeWS/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://UserModel/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/StackExchangeWS/UserWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://UserModel/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://UserModel/", "UserWSPort"), UserWS.class, features);
    }
