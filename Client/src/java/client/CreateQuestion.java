...
public class CreateQuestion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String res = createQuestion(name, email, qtopic, qcontent);
    ...
    private String createQuestion(java.lang.String name, java.lang.String email, java.lang.String qtopic, java.lang.String qcontent) throws Exception_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        service.StackExchangeService port = service.getStackExchangeServicePort();
        return port.createQuestion(name, email, qtopic, qcontent);
    }
