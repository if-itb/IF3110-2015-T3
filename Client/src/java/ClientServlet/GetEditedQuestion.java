...
// Servlet for getting the detail of a question that will be edited
...
public class GetEditedQuestion extends HttpServlet {
	...
	if (rh.isHasToken()) {
	    ...
	    if (question == null) {
		response.sendRedirect("expired");          // The result is the token is expired
	    } else {
		// Set attributes and redirect to Edit page
