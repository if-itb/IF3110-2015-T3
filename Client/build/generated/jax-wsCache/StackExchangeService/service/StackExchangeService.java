...
public interface StackExchangeService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getQuestionWithoutValidation", targetNamespace = "http://service/", className = "service.GetQuestionWithoutValidation")
    @ResponseWrapper(localName = "getQuestionWithoutValidationResponse", targetNamespace = "http://service/", className = "service.GetQuestionWithoutValidationResponse")
    @Action(input = "http://service/StackExchangeService/getQuestionWithoutValidationRequest", output = "http://service/StackExchangeService/getQuestionWithoutValidationResponse", fault = {
        @FaultAction(className = Exception_Exception.class, value = "http://service/StackExchangeService/getQuestionWithoutValidation/Fault/Exception")
    })
