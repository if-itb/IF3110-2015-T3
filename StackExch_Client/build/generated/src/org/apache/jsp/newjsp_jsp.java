...
public final class newjsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<ul>\n");
      out.write("  <li ng-repeat=\"x in names\">\n");
      out.write("    {{ x.content + ', ' + x.author }}\n");
      out.write("  </li>\n");
      out.write("</ul>\n");
      out.write("\n");
      out.write("</div>\n");
      out.write(" id);\n");
      out.write("    $http.get(url_)\n");
      out.write("<script>\n");
      out.write("var app = angular.module('myApp', []);\n");
      out.write("app.controller('customersCtrl', function($scope, $http) {\n");
      out.write("    var id = 1;\n");
      out.write("    var url_ = \"http://localhost:21215/CommentandVote/AllComment?id=\"+id;\n");
