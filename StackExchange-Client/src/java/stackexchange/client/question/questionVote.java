...
public class questionVote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(email.equals("") || token.equals("")){
            ...
            voteQuestion(question, token, isUp);
    ...
    private void voteQuestion(stackexchange.webservice.Question question, java.lang.String token, boolean inc) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        stackexchange.webservice.QuestionWS port = service.getQuestionWSPort();
        port.voteQuestion(question, token, inc);
    }
