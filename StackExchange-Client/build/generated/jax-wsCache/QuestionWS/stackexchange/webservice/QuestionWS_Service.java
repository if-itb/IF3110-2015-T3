 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://webservice.stackexchange/", wsdlLocation = "http://localhost:8081/StackExchange-WebService/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUESTIONWS_QNAME = new QName("http://webservice.stackexchange/", "QuestionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StackExchange-WebService/QuestionWS?wsdl");
    ...
    public QuestionWS getQuestionWSPort() {
        return super.getPort(new QName("http://webservice.stackexchange/", "QuestionWSPort"), QuestionWS.class);
    }
    ...
    public QuestionWS getQuestionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.stackexchange/", "QuestionWSPort"), QuestionWS.class, features);
    }
